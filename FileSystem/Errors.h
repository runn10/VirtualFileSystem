...
{
public:
	inline static void printError(std::string error, std::ofstream& out) { out << error << std::endl; }
	...
	static const int FILE_ALREADY_OPEN		= -2; // Open
	static const int DISK_NOT_SAVED			= -2; // Initialize / Restore
};
